...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('LaundryApplication', '0001_initial'),
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='batchlog',
            index=models.Index(fields=['Time'], name='BatchLogs_Time_b6267f_idx'),
        ),
        migrations.AddIndex(
            model_name='batchlog',
            index=models.Index(fields=['RecipeName'], name='BatchLogs_RecipeN_7deaf9_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['date', 'meter_name'], name='LaundryAppl_date_624261_idx'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='schedule',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='LaundryApplication.parsingschedule'),
        ),
        migrations.AddField(
            model_name='processedfile',
            name='task',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='processed_files_rel', to='LaundryApplication.parsingtask'),
        ),
        migrations.AddField(
            model_name='profile',
            name='user',
